...
WebUI.setEncryptedText(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien haslo_editPass'), 'iGDxf8hSRT4=')

WebUI.setEncryptedText(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien haslo_editPassRepeat'), 'iGDxf8hSRT4=')

WebUI.click(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien haslo_changePassword'))

WebUI.verifyElementText(findTestObject('Page_PSTO webMessenger - Zalogowano/p_Podane dotychczasowe haslo jest bledne'), 
