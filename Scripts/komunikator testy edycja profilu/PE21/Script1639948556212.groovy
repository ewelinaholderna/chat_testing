...
WebUI.scrollToElement(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Pe_editWww'), 2)

WebUI.setText(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Pe_editWww'), 'https://www.wp.pl/')
