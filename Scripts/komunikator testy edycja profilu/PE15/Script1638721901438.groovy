...
WebUI.scrollToElement(findTestObject('Page_PSTO webMessenger - Zalogowano/textarea_Zmie dane_editOSobie'), 2)

WebUI.setText(findTestObject('Page_PSTO webMessenger - Zalogowano/textarea_Zmie dane_editOSobie'), 'Mam na imię Ewelina. Mieszkam w Poznaniu.')
...
value_text = WebUI.getAttribute(findTestObject('Page_PSTO webMessenger - Zalogowano/textarea_Zmie dane_editOSobie'), 'value')
