...
WebUI.setText(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editMail'), 'ewelina.holderna@gmail.com')
...
value_text = WebUI.getAttribute(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editMail'), 'value')
