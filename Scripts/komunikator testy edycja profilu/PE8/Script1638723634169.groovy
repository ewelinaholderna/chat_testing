...
WebUI.setText(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmie dane_editName'), '987!+')

WebUI.click(findTestObject('Object Repository/Page_PSTO webMessenger - Zalogowano/input_Wybierz nowy avatar_editBttn'))

value_text = WebUI.getAttribute(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmie dane_editName'), 'value')
