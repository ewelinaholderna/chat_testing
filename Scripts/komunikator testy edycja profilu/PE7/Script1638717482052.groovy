...
WebUI.setText(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editName'), 'Ewa')
...
value_text = WebUI.getAttribute(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editName'), 'value')
