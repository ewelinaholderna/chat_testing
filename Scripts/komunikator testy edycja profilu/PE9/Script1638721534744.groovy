...
WebUI.setText(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editSurname'), 'Nowak')
...
value_text = WebUI.getAttribute(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editSurname'), 'value')
