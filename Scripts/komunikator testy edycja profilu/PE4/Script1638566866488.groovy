...
WebUI.setEncryptedText(findTestObject('Page_PSTO webMessenger - Zalogowano/input_Zmien haslo_editPass'), '4nvbrPglk7k=')
...
WebUI.verifyElementText(findTestObject('Page_PSTO webMessenger - Zalogowano/p_Podane Hasla roznia sie'), 'PODANE HASŁA RÓŻNIĄ SIĘ!')
